/*
 * CSCI 21 Programming Challenge #9
 * Creating a spaceship reference program.
 *
 * Robert McAnulty
 * Date created: 26Feb14
 * Last date modified: 26Feb14
 *
 * SOURCES: challenge-9.cpp
 */
#include <cassert>
#include <iomanip>
#include <iostream>
...
{
    stringstream specs;
    specs.setf(ios::fixed | ios::showpoint);
    specs.precision(2);
    specs << name << ", top speed: warp " << topSpeed << ", fuel source: " << fuelSource << ", crew capacity: " << crewCapacity;
    return specs.str();
}
