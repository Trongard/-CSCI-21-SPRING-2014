/*
 * CSCI 21 Programming Challenge #20
 * Working with insert to create a list.
 *
 * Robert McAnulty
 * Date created: 16Apr14
 * Last date modified: 16Apr14
 *
 * SOURCES: challenge-20-spec.txt, challenge-20-unittest.cpp, parts from my pc19
 */
