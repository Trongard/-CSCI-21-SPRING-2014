 ...
 *
 * Robert McAnulty
 * Date created: 29 Jan 14
 * Last date modified: 29 Jan 14
 *
 * My saved Lab 2 from CSCI 20; etc.
 */
#include <cassert>
#include <cmath>
#include <iostream>
...
{
	// CODE HERE
	quarters = initialValue % 100 / 25;
    dimes = initialValue % 100 % 25 / 10;
    nickels = initialValue % 100 % 25 % 10 / 5;
    pennies = initialValue % 100 % 25 % 10 % 5 / 1;
}
