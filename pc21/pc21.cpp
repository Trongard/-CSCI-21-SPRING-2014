/*
 * CSCI 21 Programming Challenge #21
 * Using templates.
 *
 * Robert McAnulty
 * Date created: 21Apr14
 * Last date modified: 21Apr14
 *
 * SOURCES: challenge-21-unittest.cpp, challenge-21-spec.txt, parts of my project 2 and pc20, etc.
 */
