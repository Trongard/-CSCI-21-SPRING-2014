/*
 * CSCI 21 Programming Challenge #29
 * Using vectors and standard template library.
 *
 * Robert McAnulty
 * Date created: 21May14
 * Last date modified: 21May14
 *
 * SOURCES: challenge-29-unittest.cpp, etc.
 */
